...
loadCoreGame( "garryscape/gamemode/garryscape/base" );
loadCharacters( "garryscape/gamemode/garryscape/characters" );
loadSpells( "garryscape/gamemode/garryscape/spells" );